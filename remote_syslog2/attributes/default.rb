...
default['remote_syslog2']['config'] = {
  files: ["/srv/www/verecho/shared/log/production.log", "/srv/www/verecho/shared/log/unicorn.stdout.log", "/srv/www/verecho/shared/log/unicorn.stderr.log", "/var/log/nginx/app.verecho.com.access.log", "/var/log/nginx/app.verecho.com.error.log"],
  exclude_files: [],
  exclude_patterns: [],
